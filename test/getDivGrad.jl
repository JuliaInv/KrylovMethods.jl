function getDivGrad(n1,n2,n3)
	...
	D1 = kron(SparseMatrixCSC(1.0I, n3, n3),kron(SparseMatrixCSC(1.0I, n2, n2),ddx(n1)))
	D2 = kron(SparseMatrixCSC(1.0I, n3, n3),kron(ddx(n2),SparseMatrixCSC(1.0I, n1, n1)))
	D3 = kron(ddx(n3),kron(SparseMatrixCSC(1.0I, n2, n2),SparseMatrixCSC(1.0I, n1, n1)))
