...
x2,f2, = minres(Af,rhs,maxIter=10,rtol=1e-12,gtol=1e-12,btol=1e-20,out=0)
...
A = A*A'
rhs = randn(20)
x,f, = minres(A,rhs,maxIter=20,rtol=1e-20,gtol=1e-20,btol=1e-10,condlim=1e20,out=2)
@test f==-2
...
rhs = zeros(20)
x = minres(Af,rhs,maxIter=20,rtol=1e-20,gtol=1e-20,btol=1e-10,condlim=1e20,out=2)
@test all(x.==0)
@test mv==0
